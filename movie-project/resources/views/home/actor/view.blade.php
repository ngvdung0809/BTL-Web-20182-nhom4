	...
	<div class="container">
		<div class="row ipad-width">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="mv-ceb">
					<img src="{{asset(('/storage/' . $actor->image))}}" alt="" height="476px" width="330px">
				</div>
			</div>
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct">
					<h1 class="bd-hd">{{$actor->name}}</h1>
					<p class="ceb-single">Diễn viên  |  Số lượt xem: {{$actor->view}}</p>
					<br><br><br><br><br>
						        ...
						        <div id="overviewceb" class="tab <?php if($filmactivestate == 0) {echo "active";} ?>">
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">		
						            		<div class="viewtable">
						            			...
						            			<tr>
						            				<td>	   			
									            		<div class="boldviewtext">Tên đầy đủ: <p>{{$actor->name}}</p> 
									            		</div>	
						            				</td>
						            				<td>	   			
									            		<div class="boldviewtext">Giới tính: <p>{{$actor->gender}}</p> 
									            		</div>	
						            				</td>					            				
						            			</tr>
						            			<tr>
						            				<td>	   			
									            		<div class="boldviewtext">Ngày sinh: <p>{{$actor->birth_day}}</p> 
									            		</div>	
						            				</td>
						            				<td>	   			
									            		<div class="boldviewtext">Quốc gia: <p>{{$actor->country_id}}</p> 
									            		</div>	
						            				</td>
						            			</tr>
						            			<tr>
						            				<td>	   			
									            		<div class="boldviewtext">Email: <p>{{$actor->email}}</p> 
									            		</div>	
						            				</td>
						            			</tr>
						            			<tr>
						            				<td>	   			
									            		<div class="boldviewtext">Sở trường: <p>{{$actor->forte}}</p> 
									            		</div>	
						            				</td>						            				
						            			</tr>
						            			<tr>
						            				<td>	   			
									            		<div class="boldviewtext">Sở thích: <p>{{$actor->hobby}}</p> 
									            		</div>	
						            				</td>						            				
						            			</tr>
						            			<tr>
						            				<td>	   			
									            		<div class="boldviewtext">Mô tả khác: <p>{{$actor->description}}</p> 
									            		</div>	
						            				</td>						            				
						            			</tr>
						            			<tr>
						        	...
						        	<div class="row">
						            	...
						            	<div class="topbar-filter">
											...
											<form action="{{ route('home_actor_view',$actor->id )}}" style="width: 300px;">
