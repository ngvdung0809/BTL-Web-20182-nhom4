...
@endsection
@section('content')
    @include('home.user_profile.header', ['pageHeader'=>$user->name, 'pageNow'=>'Phim đã đánh giá'])
    @include('home.user_profile.user_film', ['user'=>$user, 'films'=>$films, 'active'=>'Film Rate'])
@endsection
@section('js')
    ...
    <script src="{{ asset('js/home/user_profile/user_film.js') }}"></script>
@endsection
