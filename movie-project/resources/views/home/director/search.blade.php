@extends('home.layout')
@section('title','Tìm kiếm đạo diễn')
@section('css')
@endsection
@section('content')
<div class="hero common-hero">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="hero-ct">
					<h1>Tìm kiếm đạo diễn</h1>
					<ul class="breadcumb">
						<li class="active"><a href="{{ route('home_index') }}">Home</a></li>
						<li class="active"><span class="ion-ios-arrow-right"></span>
							<a href="{{ route('home_director_list') }}">Danh sách đạo diễn</a></li>
						<li> <span class="ion-ios-arrow-right"></span> Tìm kiếm đạo diễn</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row ipad-width2">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="topbar-filter">
					<p class="pad-change" style="padding-right: 300px;">Có tất cả <span>{{$persons->total()}}</span> đạo diễn</p>
					<label>Sắp xếp theo:</label>
					<form action="{{ route('home_director_search')}}" style="width: 300px;">
				...
				<div class="row">	
					<?php if ($persons->total() == 0) 
						echo "<h6 align=\"center\">Không tìm thấy kết quả</h6>";
							...
							echo "<h6 style=\"color: white; padding-left:30%; \" align\"center\">Tìm kiếm đạo diễn $dataarray[0] tới từ $countryname </h6>";
						}
						echo "<br>";
					?>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2" style="height:140px; ">
							<div style="height: 140px; width: 104px;">
								<img class="director-img img-responsive" src="{{ asset('/storage/' . $person->image)}}" alt="1" style="height: 140px; width: 104px; ">
							</div>
							<div class="ceb-infor">
								<h2><a href="{{ route('home_director_view',$person->id )}}">{{$person->name}}</a></h2>
			...
			<div class="col-md-3 col-xs-12 col-sm-12">
				<div class="sidebar">
					...
					<div class="celebrities">
						<h4 class="sb-title">đạo diễn nổi tiếng</h4>
						@foreach($recommends as $recommend)
						<div class="celeb-item">
							<a href="{{ route('home_director_view',$recommend->id )}}"><img class="director-img img-responsive" src="{{ asset('/storage/' . $recommend->image)}}" alt="1" height="70" width="70">
							</a>
							<div class="celeb-author">
								<h6><a href="{{ route('home_director_view',$recommend->id )}}">{{$recommend->name}}</a></h6>								
							</div>
						</div>
						@endforeach
					</div>
