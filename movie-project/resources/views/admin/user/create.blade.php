        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="box-body">
                    <div class="col-md-4 col-md-offset-4">
                        <img class="profile-user-img img-responsive img-circle" src="{{ asset('/storage/' . 'avatar_default/user_default.jpg') }}" alt="" id="image_default">
                        <div align="center">
            ...
            <div class="form-group {{ $errors->first('other_description') ? 'has-error' : ''}}">
                ...
                <div class="input-group">
                    ...
                    <input id="other_description" type="text" class="form-control{{ $errors->has('other_description') ? ' is-invalid' : '' }}" name="other_description"  placeholder="Mô tả khác" value="{{ old('other_description') }}">
                </div>
