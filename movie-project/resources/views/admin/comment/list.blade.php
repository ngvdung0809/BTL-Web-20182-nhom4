                ...
                <div class="box-body">
                    ...
                    <div class="row" style="padding-left: 10px;">
                        <button type="submit" class="btn btn-primary" style="height: 40px;"><i class="fa fa-search"></i>
                            Search</button>
                        <input name="content" type="text" placeholder="Nội dung tìm kiếm" 
                            style="width: 400px; padding: 8px 12px;  border-radius: 4px;" required>
                        <select name="type" style="width: 150px;border-radius: 4px; background-color: #d0d5e0; padding: 8px 12px; ">
