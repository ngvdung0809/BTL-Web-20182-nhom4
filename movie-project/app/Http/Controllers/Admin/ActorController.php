...
class ActorController extends Controller
{
    ...
    {
        $persons = Person::where('job', 'actor')->get()->map(function($person) {
    ...
    public function create()
    {
        ...
        return view('admin.actor.create', ['getcountries' => $getcountries]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_actor_list')->with('success', 'Thông tin '.$person->name.' được thêm mới thành công');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $getcountries = Country::all();
        return view('admin.actor.edit', ['person' => $person, 'getcountries' => $getcountries]);
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin_actor_list')->with('success', 'Thông tin '.$person->name.' đã được cập nhật thành công');
    }
    /**
     ...
     public function destroy($id)
    {
        ...
        return redirect()->route('admin_actor_list')->with('success', 'Thông tin '. $person->name.' đã được xóa thành công');
    }
}
